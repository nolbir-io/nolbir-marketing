...
A parallel system, run alongside the Phase 1 June batch above, covering product updates, feature spotlights, educational content, and audience feedback — organized using the Apple/Google/Shopify lens already defined in `docs/strategy/operating-principles.md`:
...
| **Movement** | Shopify — merchant movement / tech partner, mission not feature list | Company updates, milestones, behind-the-scenes |
| **Listen** | Cross-cutting | Polls, AMAs, direct questions, feedback prompts |

Telegram, X, and Facebook are net-new channels with no scheduling conflict, so this system launches on them immediately. Instagram and LinkedIn adopt the system once their current Phase 1 June queue clears (see per-channel files for exact handoff dates).
