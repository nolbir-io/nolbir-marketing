...
description: "When the user wants to build and scale partner ecosystems that drive revenue and platform adoption. Use when the user says 'partner program,' 'partnership architecture,' 'build vs partner,' 'partner tiering,' 'ecosystem strategy,' 'partner-led sales,' 'crawl-walk-run partnership,' or 'when does a partnership matter.' For joint campaigns and co-marketing execution, see co-marketing. For launch-specific partner motions, see launch-strategy."
license: MIT
metadata:
...
- **co-marketing** — Joint campaigns, partner identification, and co-marketing execution
- **launch-strategy** — Partner motions tied to product launches and borrowed audiences
- **pricing-strategy** — Pricing and packaging partnership deals
- **sales-enablement** — Partner-facing collateral, playbooks, and deal support
- **referral-program** — Customer referral and affiliate programs (distinct from B2B partnerships)
